...
class LMSCNet_SS(MVXTwoStageDetector):
    ...
    def foward_training(self,
        ...
        loss_sc_level_1 = BCE_ssc_loss(out_1, target_1, class_weights_level_1, self.alpha, pred_sigma_1)
        loss_sc_level_2 = BCE_ssc_loss(out_2, target_2, class_weights_level_2, self.alpha, pred_sigma_2)
        loss_sc_level_3 = BCE_ssc_loss(out_3, target_3, class_weights_level_3, self.alpha, pred_sigma_3)
        losses_pts['loss_sc_level_1'] = 1 * loss_sc_level_1
        losses_pts['loss_sc_level_2'] = 0.8 * loss_sc_level_2
        losses_pts['loss_sc_level_3'] = 0.64 * loss_sc_level_3
